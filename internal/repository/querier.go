...
type Querier interface {
	...
	DeleteBonusesByTypeByUser(ctx context.Context, arg DeleteBonusesByTypeByUserParams) (int64, error)
	DeleteClassroomByUser(ctx context.Context, arg DeleteClassroomByUserParams) (int64, error)
	DeletePenaltiesByTypeByUser(ctx context.Context, arg DeletePenaltiesByTypeByUserParams) (int64, error)
	...
	DeletePunishmentsByTypeByUser(ctx context.Context, arg DeletePunishmentsByTypeByUserParams) (int64, error)
	DeleteRefreshToken(ctx context.Context, token string) error
	DeleteRuleByUser(ctx context.Context, arg DeleteRuleByUserParams) (int64, error)
	DeleteRulesByPenaltyTypeByUser(ctx context.Context, arg DeleteRulesByPenaltyTypeByUserParams) (int64, error)
	DeleteRulesByResultingPunishmentTypeByUser(ctx context.Context, arg DeleteRulesByResultingPunishmentTypeByUserParams) (int64, error)
