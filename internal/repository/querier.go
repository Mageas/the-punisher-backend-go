...
type Querier interface {
	...
	GetUserCredentialsByIDForAuth(ctx context.Context, id uuid.UUID) (GetUserCredentialsByIDForAuthRow, error)
	...
	ListClassroomsByUserForImport(ctx context.Context, userID uuid.UUID) ([]ListClassroomsByUserForImportRow, error)
	...
	UpdateBonusByUser(ctx context.Context, arg UpdateBonusByUserParams) (UpdateBonusByUserRow, error)
	...
	UpdatePenaltyByUser(ctx context.Context, arg UpdatePenaltyByUserParams) (UpdatePenaltyByUserRow, error)
	...
	VerifyUserEmailByID(ctx context.Context, id uuid.UUID) (int64, error)
}
